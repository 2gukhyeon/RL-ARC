...
def main(script_args, training_args, model_args):
    ...
    REWARD_FUNCS_REGISTRY = {
        ...
        "mean_confidence": partial(mean_confidence_reward, format_pattern=script_args.format_pattern),
        "confidence_one_or_zero": partial(confidence_one_or_zero, format_pattern=script_args.format_pattern)
    }
