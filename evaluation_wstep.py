        ...
        if "confidence_at_end" in config.vllm_task: 
            ...
            for output in outputs:
                for i in range(config.n):
                    ...
                    # for tabc_step: use the minimum step confidence
                    if last_confidence == "":
                        ...
                        if step_conf_matches:
                            ...
                            try:
                                for step_confidence in step_conf_matches:
                                    step_confidence = float(step_confidence.strip())

                                    if 0 <= step_confidence <= 1:
                                        step_confidences.append(step_confidence)

                                    elif 1 < step_confidence <= 100:
                                        step_confidences.append(step_confidence / 100)
                                ...
                                if step_confidences:
                                    last_confidence = str(min(step_confidences))
                                else:
                                    last_confidence = ""
